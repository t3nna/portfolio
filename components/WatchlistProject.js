...
export default function WatchlistProject({color}) {


    return (
        <section className={'section project-section'}  id={'watchlist'}>
            <div className="grid-container">
                ...
                <NavigationArrows topHref={'#qr-code-generator'} bottomHref={'#introduce'}/>
                <main className="section__description">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut iste laboriosam molestiae optio
                        quaerat, sed! Aliquid, assumenda consequatur deserunt ducimus eveniet fugiat illum impedit
                        labore libero minima pariatur placeat porro recusandae. Ab aliquam atque, debitis expedita fugit
                        harum hic impedit maxime, minima, neque odit officia praesentium recusandae totam voluptatibus?
                        Ab ad amet, aperiam asperiores aspernatur atque distinctio dolores error, fuga illo laboriosam
                        maiores maxime minus natus neque nulla numquam obcaecati quam qui quod repellendus reprehenderit
                        temporibus tenetur voluptate voluptatem.
                    </p>
                </main>
                ...
                <footer className="section__footer">
                    <div className="more">
                        ...
                        <Link href={'/works/watchlist'}>
                            <a>



                        <svg width="129" height="45" viewBox="0 0 86 30" fill="white"
